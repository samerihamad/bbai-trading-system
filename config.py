...
# ─────────────────────────────────────────
UNIVERSE_SIZE           = 80        # عدد الأسهم في القائمة اليومية
UNIVERSE_MAX_CANDIDATES = 1500       # أقصى عدد مرشح يتم فحصه
MIN_AVG_VOLUME          = 150_000   # أقل حجم تداول يومي مقبول
...
S2_TP2_R            = 2.0     # الهدف الثاني = 2R (خروج 50% من الكمية)
...
# ─────────────────────────────────────────
MAX_LONG  = 3   # أقصى عدد صفقات شراء في نفس الوقت
MAX_SHORT = 2   # أقصى عدد صفقات بيع على المكشوف في نفس الوقت
MAX_TOTAL = 5   # الإجمالي الأقصى (MAX_LONG + MAX_SHORT)

# حصة كل استراتيجية
MAX_MEANREV_LONG   = 2  # MeanRev  : أقصى 2 شراء
MAX_MEANREV_SHORT  = 1  # MeanRev  : أقصى 1 بيع
MAX_MOMENTUM_LONG  = 1  # Momentum : أقصى 1 شراء
MAX_MOMENTUM_SHORT = 1  # Momentum : أقصى 1 بيع
...
# ─────────────────────────────────────────
# 12. استراتيجية Momentum
# ─────────────────────────────────────────
MOM_RSI_MIN        = 60      # RSI أدنى حد للزخم الصاعد (LONG)
MOM_RSI_MAX_SHORT  = 40      # RSI أقصى حد للزخم الهابط (SHORT)
MOM_ADX_MIN        = 25      # ADX الحد الأدنى — نريد اتجاه قوي
MOM_VOLUME_MULT    = 1.5     # الحجم يجب أن يكون 1.5x المتوسط
MOM_GAP_MIN        = 0.04    # Gap Up/Down ≥ 4% = إشارة جودة عالية
MOM_ATR_MULT_STOP  = 1.0     # وقف الخسارة = 1× ATR (أضيق من MeanRev)

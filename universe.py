...
def get_daily_universe() -> dict:
    ...
    # الخطوة 3: فلتر EMA200 — uptrend فقط
    print("📈 فلترة الأسهم بـ EMA200 (فوق المتوسط = uptrend فقط)...")
    candidates    = df.head(UNIVERSE_SIZE * 3)
    filtered_rows = []
    ...
    # نُرجع dict: {ticker: True} — كل سهم تحقق من EMA200 مسبقاً
    return {ticker: True for ticker in selected}
